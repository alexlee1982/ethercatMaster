...
/* PmCartesian */
    ...
    typedef struct {
	double j0,j1,j2,j3,j4,j5,j6,j7;		/* this.x, etc. */
    } PmJoint;
...
typedef struct
{
      PmJoint start;		/* where motion was started */
      PmJoint end;
      double jmag;
      int jmag_zero;
...
/* debug output printing */
    ...
    extern void pmPrintError(char *fmt, ...);
#endif
...
/*        |  m.x.z   m.y.z   m.z.z  |   */
    ...
    extern int pmMatRev(PmRotationMatrix m, PmRotationMatrix * mout);
	...
	extern int pmMatMatAdd(PmRotationMatrix m1, PmRotationMatrix m2,
	    PmRotationMatrix * mout);
	extern int pmMatScale(PmRotationMatrix m1, double d,
	    PmRotationMatrix * mout);
